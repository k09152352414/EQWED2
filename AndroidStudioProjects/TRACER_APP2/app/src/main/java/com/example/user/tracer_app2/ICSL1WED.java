...
public class ICSL1WED extends ActionBarActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_icsl1_wed);

        Button p1 = (Button) findViewById(R.id.button);
        p1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICLS1WEDSCHED1.class));
            }
        });
        ...
        p2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICSL1WEDSCHED2.class));
            }
        });
        ...
        p3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICSL1WEDSCHED3.class));
            }
        });
        ...
        p4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICSL1WEDSCHED4.class));
            }
        });
        ...
        p5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, AVAILABLE.class));
            }
        });
        ...
        p7.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICSL1WEDSCHED5.class));
            }
        });
        ...
        p8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICSL1WEDSCHED6.class));
            }
        });
        ...
        p9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICSL1WEDSCHED7.class));
            }
        });
        ...
        p10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, ICSL1WEDSCHED8.class));
            }
        });
        ...
        p15.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ICSL1WED.this, MAIN.class));
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.icsl1_wed, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_icsl1_wed, container, false);
            return rootView;
        }
    }
}
